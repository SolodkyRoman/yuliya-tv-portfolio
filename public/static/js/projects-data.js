...
const PROJECTS_IMAGES = new Map([
  ...
  [
    ...
    [
      {
        alt: [
          'Independence day poster 1',
          'Independence day poster 2',
          'This is war poster',
        ],
        src: [
          '/static/images/projects/posters/independence_blue.png',
          '/static/images/projects/posters/independence_yellow.png',
          '/static/images/projects/posters/this_is_war.png',
        ],
      },
      {
        alt: ['Russian warship poster', 'Putler poster', 'Mariupol poster'],
        src: [
          '/static/images/projects/posters/warship.png',
          '/static/images/projects/posters/putler.png',
          '/static/images/projects/posters/mariupol.png',
        ],
      },
    ],
  ],
  [
    PROJECT_IDS.get('experiments'),
    [
      {
        alt: ['Independence day poster 1', 'Independence day poster 2'],
        src: [
          '/static/images/projects/experiments/nothing matters 2.jpg',
          '/static/images/projects/experiments/do nothing in every possible moment 2.jpg',
        ],
      },
    ],
  ],
...
const PROJECTS_DATA = [
  ...
  },
  {
    ...
    name: 'War in Ukraine',
    thumbnailSmall: '/static/images/projects/peppy/peppy-happy.png',
    thumbnailBig: '/static/images/projects/posters/posters_animation.gif',
