    ...
    [
        [PROJECT_IDS.get('utopia'),
            [
                ...
                {
                    alt: ['', ''],
                    src: ['images/projects/utopia/utopia_left.png', 'images/projects/utopia/utopia_right.png'],
                },
                {
                    alt: '',
...
const PROJECTS = PROJECTS_DATA.map(project => ({...project, images: PROJECTS_IMAGES.get(project.id) || []}));
